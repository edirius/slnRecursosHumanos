...
namespace CapaUsuario.ExportarSunat
{
    public partial class frmExportarDatosTrabajadores : Form
    {
        ...
        {
            dgvListarTrabajadores.DataSource = oExportar.ListarTrabajadoresporFechaInicio(cbMes.Text, cbAños.Text);
        ...
        public void concatenarDatos()
        {
            ...
            try
            {
                for (int i = 0; i < dgvListarTrabajadores.Rows.Count; i++)
                {
                    ...
                    string paisDoc = "604";
                    string apPaterno = dgvListarTrabajadores[3, i].Value.ToString();
                    string apMaterno = dgvListarTrabajadores[4, i].Value.ToString();
                    string nombres = dgvListarTrabajadores[5, i].Value.ToString();
                    DateTime fechaNac = Convert.ToDateTime(dgvListarTrabajadores[6, i].Value.ToString());

                    string sexo = dgvListarTrabajadores[7, i].Value.ToString();
                    Sexo(sexo);
                    ...
                    string nroVia = dgvListarTrabajadores[13, i].Value.ToString();
                    string departamento = "";
                    string interior = dgvListarTrabajadores[14, i].Value.ToString();
                    ...
                    string block = "";
                    string etapa = "";
                    string tipoZona = dgvListarTrabajadores[15, i].Value.ToString();
                    string nombreZona = dgvListarTrabajadores[16, i].Value.ToString();
                    string referencia = dgvListarTrabajadores[17, i].Value.ToString();
                    string ubigeo = dgvListarTrabajadores[18, i].Value.ToString();
