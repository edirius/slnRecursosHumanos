...
namespace CapaDeNegocios
{
    public class cTrabajador
    {
        ...
        private string nrorenta4ta;

        public string NroRenta4ta
        {
            get { return nrorenta4ta; }
        ...
        public DataTable ObtenerListaTrabajadoresConReloj3(string FiltroTrabajadores, string fnombres, string fapellidoPaterno, string fapellidoMaterno, string fdni, string fRegimen, string fmeta)
        {
            string filtro = "t";
            string regimenfiltro = "%";
            string filtroMeta = "%";
            ...
            return Conexion.GDatos.TraerDataTable("spListarTrabajadoresFiltroReloj3", filtro, fnombres + '%', fapellidoPaterno + '%', fapellidoMaterno + '%', fdni + '%', regimenfiltro, filtroMeta);
        }

        public DataTable ObtenerListaTrabajadoresConReloj4(string FiltroTrabajadores, string fnombres, string fapellidoPaterno, string fapellidoMaterno, string fdni, string fRegimen, string fmeta)
        {
            string filtro = "t";
            string regimenfiltro = "%";
            string filtroMeta = "%";
            ...
            return Conexion.GDatos.TraerDataTable("spListarTrabajadoresFiltroReloj4", filtro, fnombres + '%', fapellidoPaterno + '%', fapellidoMaterno + '%', fdni + '%', regimenfiltro, filtroMeta);
        }
