...
namespace CapaDeNegocios.Reportes
{
    public  class cImprimirReportePDF
    {
        public void ImprimirReportePDF(cReportePDF oReportePDF)
        {
            ...
            {
                throw new cReglaNegociosException("Error en el metodo ImprimirReportePDF:" + ex.Message);
            }
        }
        ...
        public void ImprimirReportePDFBOLETAVERTICAL(cReportePDF oReportePDF)
        {
            string ruta = System.IO.Directory.GetCurrentDirectory();
